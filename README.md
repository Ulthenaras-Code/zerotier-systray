Procédure — ZeroTier Tray (systray GNOME/Ubuntu, v4)
Contexte
...
o	Au premier lancement : "Aucun réseau configuré"
o	Un réseau par ligne une fois ajouté, case à cocher = connecté/déconnecté

(clic direct)
o	Gérer les réseaux → sous-menu par réseau : Détails / Renommer / Oublier
o	Ajouter un réseau... → saisie du Network ID (16 caractères) puis nom

(obligatoire)
o	Rafraîchir : aussi automatique toutes les 15 secondes
